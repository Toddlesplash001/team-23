  ...
  return (
    <MDBAccordion flush initialActive={1}>
      ...
      >
        ...
        are for girls, namely Vindhya and Kalpana Chawla.
      </MDBAccordionItem>
      <MDBAccordionItem
        collapseId={2}
      ...
      >
        ...
        the fourth year, you get Kurukshetra hostel.
      </MDBAccordionItem>
      <MDBAccordionItem
        collapseId={3}
      ...
      >
        ...
        reason as to why they want a room in the hostel.
      </MDBAccordionItem>
      <MDBAccordionItem
        collapseId={5}
      ...
      >
        ...
        indoor games such as chess, carrom, table tennis etc.
      </MDBAccordionItem>
      <MDBAccordionItem
        collapseId={6}
      ...
      >
        ...
        but all of these facilities are available for the day scholars too.
      </MDBAccordionItem>
      <MDBAccordionItem
        collapseId={7}
      ...
      >
        ...
        wheelers are not allowed inside the hostel parking and so they may bring
        four wheelers, but at their own risk.
      </MDBAccordionItem>
      <MDBAccordionItem
        collapseId={8}
      ...
      >
        ...
        also provided with evening snacks.
      </MDBAccordionItem>
      <MDBAccordionItem
        collapseId={10}
        headerTitle="Can the hostelers bring their own electrical appliances?"
      >
        The students are only allowed to bring low power electrical appliances.
      </MDBAccordionItem>
      <MDBAccordionItem
        collapseId={11}
      ...
      >
        ...
        the warden, assistants are there who work to ensure smooth working of
        hostels. Apart from this, students also are appointed as hostel heads
        and incharges.
      </MDBAccordionItem>
      <MDBAccordionItem
        collapseId={13}
        headerTitle="Are there laundry facilities available for the students?"
      >
        Yes, the college has laundry facilities available for the students at a
        nominal price, and the clothes are taken for washing after a span of a
        few days.
      </MDBAccordionItem>
      <MDBAccordionItem
        collapseId={14}
